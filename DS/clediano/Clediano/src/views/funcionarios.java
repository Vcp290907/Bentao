...
public class funcionarios {
  public funcionarios(){
    ...
    BTConsulatar.addActionListener(e -> {
      new consultaFuncionarios(); // Abre a tela de consulta
    });
    ...
    BTVoltar.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            index.main(null); // Volta para a tela principal
        }
    });
  ...
  public void atualizarTabela(List<Funcionarios> func) {
    // TODO Auto-generated method stub
    throw new UnsupportedOperationException("Unimplemented method 'atualizarTabela'");
  }
}
